...
public class TableDoctors extends javax.swing.JFrame {
    ...
    public TableDoctors() {
        try {
            ...
            header.add("Tp No");
            initComponents();
            setIconImage(Toolkit.getDefaultToolkit().getImage(TableDoctors.class.getResource("/resources/logo.png")));
            ...
            setTitle("Listing of All Doctors");
        } catch (Exception ee) {
    ...
    public Vector getAbbr() throws Exception {
        ...
        PreparedStatement pre = con.prepareStatement("select * from doctors");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TableDoctors().setVisible(true);
            }
        });
    }
