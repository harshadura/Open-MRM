...
public class TableChanneling extends javax.swing.JFrame {
    ...
    public TableChanneling() {
        try {
            ...
            header.add("channelData");
            header.add("channelTime");
            header.add("patientName");
            header.add("tpno");
            header.add("guardian");
            header.add("address");
            initComponents();
            setIconImage(Toolkit.getDefaultToolkit().getImage(TableChanneling.class.getResource("/resources/logo.png")));
    ...
    public Vector getAbbr() throws Exception {
        ...
        PreparedStatement pre = con.prepareStatement("select * from Channeling");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new TableChanneling().setVisible(true);
            }
        });
    }
